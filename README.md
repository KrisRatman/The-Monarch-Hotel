...
📄 **[Кейс с разбором проекта](case-study/index.html)** — витрина, форма бронирования и реконструкция админ-панели (статусы заявок, meta box, быстрые действия) с разбором того, как это устроено под капотом.
